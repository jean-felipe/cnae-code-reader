  ...
  describe '#call' do
    context 'when receive valid trades' do
      it 'creates the trades' do
        expect{ saver.call }.to change(Trade, :count).by(2)
      end
    end
      ...
      let(:wrong_trades) do
        [
          {:trade_type=>'9', :date=>'', :price=>'7398475938', :cpf=>'47593475938',
           :card_number=>'4753****3453', :hour=>'453453'},
          {:trade_type=>'5', :date=>'23423423', :price=>'4247772347', :cpf=>'12222123123',
           :card_number=>'31237687', :hour=>''},
        ]
      end
      let(:wrong_save) { described_class.new(trades: wrong_trades) }

      it 'raises and error' do
        expect{ wrong_save.call }.to change(Trade, :count).by(0)
      end
    end
  end
end
